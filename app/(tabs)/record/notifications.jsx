// ReminderScreen.js - Updated for Expo Go compatibility with native class names
  ...
  return (
    <View className='flex-1 bg-gray-100'>
      <ScrollView className='p-4'>
        <Text className='text-2xl font-bold mb-6 text-blue-600'>Reminder Settings</Text>
        {/* Reminder Form */}
        <View className='bg-white rounded-lg p-4 shadow-md mb-6'>
          <Text className='text-lg font-semibold mb-4 text-gray-800'>Create New Reminder</Text>
          ...
          />
          <Text className='text-gray-600 mb-1'>Message (optional)</Text>
          <TextInput
            className='border border-gray-300 rounded-md p-2 mb-3'
            value={body}
        ...
        {/* Reminders List */}
        <Text className='text-xl font-bold mb-3 text-gray-800'>Your Reminders</Text>
        {reminders.length === 0 ? (
